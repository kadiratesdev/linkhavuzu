...
?>
	  ...
	  <div id="info"><span>Lütfen sohbet esnasında <b>Argo </b> kullanmamaya özen gösterin.<a href="#" title="">KAPAT</a></span></div>
...
audio.volume = 0.5;
</script><a href="#" title="">KAPAT</a></span></div>
        ...
        <div id="message">
            ...
            <div id="new-message">
                ...
                <span>
                    <input readonly id="msg" value="<?php echo $kulAdi; ?>" type="text" name="name" /></span>
                <span>
...
<html>
<head>
   <title>LinkHavuzu Sohbet Kanalı</title>
...
<body onLoad="UpdateTimer();">
 <div id="live-chat">
        <div id="title">
            <div class="left">
                <h2> LinkHavuzu Sohbet Kanalı </h2>
            </div>
            <div class="right"></div>
        </div>
		<?php 
...
if (!isset($_SESSION['nickname']) ){ 
    createForm();
      ...
      $_SESSION['nickname'] = $name;
    ?>
              <div id="info"><span><audio id="stream" controls  autoplay  preload="none"    style="width:400px;max-width:500px;">
<source src="http://151.80.144.19:9994/;" type="audio/mpeg">
</audio> </span></div>
     ...
     ?>
      ...
      <div id="sender" onKeyUp="keypressed(event);"> 
         <input placeholder="Mesajı Yazdıktan Sonra Enter'e Basabilirsiniz." type="text" name="msg" size="30" id="msg" />
