...
<div class="module form-module">
  <div class="toggle"><i class="fa fa-times fa-pencil"></i>
    <div class="tooltip">Giriş Yap</div>
  </div>
  ...
  <div class="form">
    ...
    <form action="kayit.php" method="POST">
      <input type="text" name="txtAdiSoyadi" placeholder="Adı Soyadı"/>
	  ...
	  <?php
	  $uyeKodu = @$_GET['reflink'];
	  $uzunluk = strlen($uyeKodu);
	  if($uzunluk>0){
	  echo '  <input readonly type="text" name="txtUyeKodu" value="'.$uyeKodu.'"/>';
	  echo 'Referans Kodu Düzenlenemez.';
	  }
