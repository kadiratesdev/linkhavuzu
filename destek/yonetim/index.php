                      ...
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
							 ...
							 $query = $db->query("SELECT * from tblbildirim where durum=0");
							 if($query){
								 ...
								 <td>'.$yontem.'</td>
                                  <td>
                                      <a class="btn btn-success" href="bildirim/onayla.php?id='.$bildirimId.'"> <i class="icon_check_alt2"></i> Onayla</a>
									    
                                      <a class="btn btn-danger" href="bildirim/sil.php?id='.$bildirimId.'"> <i class="icon_close_alt2"></i> Sil</a> 
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              <tr>
							   <th><i class="icon_cogs"></i> Destek No </th>
                                 <th><i class="icon_profile"></i> Adı Soyadı</th>
